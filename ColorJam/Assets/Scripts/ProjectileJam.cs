...
public class ProjectileJam : MonoBehaviour {
	...
	void Start () {
		prefabRed = Resources.Load ("projectileRed") as GameObject;
        prefabBlue = Resources.Load("projectileBlue") as GameObject;
        prefabYellow = Resources.Load("projectileYellow") as GameObject;
        prefab = prefabRed;
